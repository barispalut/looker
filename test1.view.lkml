# The name of this view in Looker is "Events 20220726"
view: events_20220726 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `analytics_270556009.events_20220726`
    ;;
...
# The name of this view in Looker is "Events 20220726 Items"
view: events_20220726__items {
  ...
  dimension: events_20220726__items {
    type: string
    hidden: yes
    sql: events_20220726__items ;;
  }
...
# The name of this view in Looker is "Events 20220726 Event Params"
view: events_20220726__event_params {
  ...
  dimension: events_20220726__event_params {
    type: string
    hidden: yes
    sql: events_20220726__event_params ;;
  }
...
# The name of this view in Looker is "Events 20220726 User Properties"
view: events_20220726__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20220726__user_properties {
    type: string
    hidden: yes
    sql: events_20220726__user_properties ;;
  }
